...
namespace FootyScorer.Droid.Renderers
{
	public class ExtendedEditorRenderer : EditorRenderer
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<Editor> e)
		{
			...
			Control.EditorAction += ControlOnEditorAction;
		}

		private void ControlOnEditorAction(object sender, TextView.EditorActionEventArgs e)
		{
			e.Handled = false;
			if (e.ActionId != ImeAction.Next) return;
